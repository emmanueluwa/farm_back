...
export const validateMyFarmRequest = [
  body("farmName").isString().notEmpty().withMessage("Farm name is required."),
  ...
  body("produce")
    .isArray()
    .withMessage("Produce must be an array")
    .not()
    .isEmpty()
    .withMessage("Produce array must not be empty"),
